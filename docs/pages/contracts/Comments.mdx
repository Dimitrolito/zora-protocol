...
Developers can integrate the Comments contract into on their platform from day one and earn referral rewards when users spark a comment on their platform. 
